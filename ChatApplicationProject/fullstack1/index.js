...
app.get('/fetchdatafrommongooseforevent', function (req, res, next) {
    event.find({})
    .then(data => {  res.send( data);}).catch (err => {  throw err;});
});
    
app.get('/fetchdatafrommongooseforchat', function (req, res, next) {
    chat.find({})
    .then(data => {  res.send( data);}).catch (err => {  throw err;});
});

app.get('/fetchdatafrommongooseforuser', function (req, res, next) {
    user.find({})
    .then(data => {  res.send( data);}).catch (err => {  throw err;});
});
